...
extern const char *RESTART_DEVICE_KEY;
...
typedef enum 
{
    ...
    NODE_NOT_IN_GROUP,
    /* RS485 relay validation (gateway-side only — NODE_METER_CONFIG_PACKET,
       NODE_GPIO_CONFIG_PACKET, NODE_GPIO_SET_PACKET, NODE_SUMAN_AC_CONTROL_PACKET) */
    MISSING_SLAVE_ADDR,
    SLAVE_ADDR_EXCEEDING_RANGE,
    MISSING_NODE_TYPE,
    NODE_TYPE_INVALID_FORMAT,
    MISSING_ACTION,
    ACTION_INVALID_FORMAT,
    MISSING_LABEL,
    LABEL_EXCEEDING_RANGE,
    MISSING_REG_COUNT,
    REG_COUNT_EXCEEDING_RANGE,
    MISSING_REGISTER_MAP,
    REGISTER_MAP_INVALID_FORMAT,
    REGISTER_MAP_ENTRY_INVALID,
    MISSING_CHANNEL_MASK,
    CHANNEL_MASK_EXCEEDING_RANGE,
    MISSING_DIRECTION,
    DIRECTION_INVALID_FORMAT,
    MISSING_PULL,
    PULL_INVALID_FORMAT,
    MISSING_LEVEL,
    LEVEL_INVALID_FORMAT,
    MISSING_WRITE_MASK,
    MISSING_SET_TEMP,
    SET_TEMP_EXCEEDING_RANGE,
    MISSING_OPERATING_MODE,
    MISSING_RESET_FAULT,
    MISSING_CONTROL_OPTION,
    MISSING_HANDSET_CTRL_TIME,
}error_codes;
...
typedef enum
{
    ...
    /* RS485-specific packets — start at 151, clear of existing range.
       Values fixed to match the RS485 node's common_types.h exactly. */
    NODE_METER_CONFIG_PACKET            = 151,
    NODE_METER_READING_PACKET           = 152,
    NODE_METER_READING_1P_PACKET        = 153,
    ...
    NODE_METER_CONFIG_ACK               = 160,
    NODE_GPIO_CONFIG_ACK                = 161,
    NODE_GPIO_SET_ACK                   = 162,
    NODE_SUMAN_AC_CONTROL_ACK           = 163,
    MAX_RS485_PACKET_ID,
    /*MISC*/
    TEST_PACKET = 999
}mqtt_packets;
